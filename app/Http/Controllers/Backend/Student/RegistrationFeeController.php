...
class RegistrationFeeController extends Controller
{
    ...
    public function regFeeView(){
        ...
        return view('backend.student.registration_fee.registration_fee', $data);
    }// END METHOD ********************************
    ...
    public function RegFeeClassData(Request $request){
        ...
        foreach ($allStudent as $key => $v) {
            $registrationfee = FreeCategoryAmount::where('fee_category_id','1')->where('class_id',$v->class_id)->first();
            $color = 'success';
